...
def open_asset(file_name)
 ...
 #https://unsplash.com/photos/EfMqOhtst7E
  ...
  Message.create(user_id: 1, body: "Hey there", conversation_id: 1)
  Message.create(user_id: 3, body: "Hiiii", conversation_id: 1)
  Message.create(user_id: 1, body: "What's up?", conversation_id: 1)
  Message.create(user_id: 3, body: "Not much", conversation_id: 1)
  Message.create(user_id: 3, body: "Hate this quarantine", conversation_id: 1)
  Message.create(user_id: 3, body: "What about you?", conversation_id: 1)
  Message.create(user_id: 1, body: "Same", conversation_id: 1)
  Message.create(user_id: 3, body: "Oh ok cool", conversation_id: 1)
